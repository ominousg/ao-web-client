...
function ServerPacketDecodeAndDispatch(buffer, handler) {
	...
	switch (PacketID) {
		...
		case 47: {
			...
			handler.handleChangeInventorySlot(
				Slot,
				ObjIndex,
				ObjName,
				Amount,
		...
		case 59: {
			...
			handler.handleChangeNPCInventorySlot(
				Slot,
				ObjName,
				Amount,
				Price,
		...
		case 86: {
			...
			handler.handleChangeUserTradeSlot(
				OfferSlot,
				ObjIndex,
				Amount,
				GrhIndex,
