...
export const MapaGlobalSVG = () => {
  ...
  return (
    <div css={mapaStyles}>
      {isLoading ?
        <img
          src='../imagenes/popups/mapa_1_skeleton.png'
          alt='skeleton mapa global'
        />
        :
        <svg width="650" height="550" >
          <text x={92} y={10} css={borderedTextStyle}> Micro - AO </text>
          <text x={92} y={10} css={textStyle}> Micro - AO </text>
          <Filters />
