...
const Text = ({ x, y, content }) => {
  return (
    <>
      <text x={x} y={y} css={borderedTextStyle}> {content} </text>
      <text x={x} y={y} css={textStyle}> {content} </text>
    </>
  )
}
...
export const MapaDungeonsSVG = () => {
  ...
  return (
    <div css={mapaStyles}>
      {isLoading ?
        <img
          src='../imagenes/popups/mapa_2_skeleton.png'
          alt='skeleton mapa dungeons'
        />
        :
